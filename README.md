...
3. Com a versão da linguagem golang mencionada na seção anterior devidamente instalada, juntamente com o software de teste para consumo de API's, será necessário, através do prompt de comando do seu sistema operacional, navegar até á raiz do projeto. Após isso, na pasta <src/github.com/marcoscarvalho04/pismo-teste> execute o comando <go run main.go> para dar início ao sistema. 
4. O sistema iniciará sempre na porta padrão: 1000. Esta porta pode ser configurada no arquivo config.yaml presente em: <src/github.com/marcoscarvalho04/pismo-teste> para qualquer porta que assim desejar. 
